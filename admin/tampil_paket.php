...
<html lang="en">
  ...
  <body>
    ...
    <body>
        <h3>Tampil Paket</h3><a href="tambah_paket.php" class="btn btn-success"> Tambah Paket</a>
        <table class="table table-hover table-striped">
            <thead>
                <tr>
                    <th>NO</th><th>JENIS PAKET<th>HARGA</th>
                    <th>AKSI</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="ubah_paket.php?id_paket=<?=$data_paket['id_paket']?>"
