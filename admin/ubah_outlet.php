  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	              <a href="tampil_user.php"><span class="fa fa-outlet mr-3"></span> Data User</a>
	          </li>
	          <li>
	              <a href="tampil_member.php"><span class="fa fa-outlet mr-3"></span> Data Member</a>
	          </li>
              <li>
	              <a href="tampil_outlet.php"><span class="fa fa-outlet mr-3"></span> Data Outlet</a>
	          </li>
			  <li>
	              <a href="tampil_paket.php"><span class="fa fa-outlet mr-3"></span> Data Paket</a>
	          </li>
	        </ul>
