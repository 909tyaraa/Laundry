...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h3>Tampil Outlet</h3><a href="tambah_outlet.php" class="btn btn-success"> Tambah Outlet</a>
        <table class="table table-hover table-striped">
            <thead>
                <tr>
                    <th>NO</th><th>NAMA OUTLET<th>ALAMAT</th>
                    <th>AKSI</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="ubah_outlet.php?id_outlet=<?=$data_outlet['id_outlet']?>"
                    class="btn btn-success">Ubah</a> | <a
                    href="hapus_outlet.php?id_outlet=<?=$data_outlet['id_outlet']?>"
