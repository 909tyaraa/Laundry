...
if($_POST){
    ...
    for ($i=0; $i < count($paket); $i++) { 
        ...
        ('$id_transaksi','$id_member','$tgl','$batas_waktu','$tgl_bayar','$status','$dibayar','$kategori','$id_user','$total')";
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            for ($i=0; $i < count($paket); $i++) { 
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    # jika gagal insert ke table detail_transaksi
            ...
            # jika gagal insert tabel transaksi
            echo mysqli_error($conn);
        }
    }
