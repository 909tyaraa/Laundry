...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h3>Tampil Member</h3><a href="tambah_member.php" class="btn btn-success"> Tambah Member</a>
        <table class="table table-hover table-striped">
            <thead>
                <tr>
                    <th>NO</th><th>NAMA<th>AlAMAT</th>
                    <th>JENIS KELAMIN</th><th>NO TELEPON</th><th>AKSI</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td><a href="ubah_member.php?id_member=<?=$data_member['id_member']?>"
